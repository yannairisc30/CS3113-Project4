...
enum EntityType { PLATFORM, PLAYER, ENEMY, FLAG};
...
private:
    ...
    bool player_hit_enemy_from_above = false;
...
public:
    ...
    bool      const get_hit_enemy_above() const { return player_hit_enemy_from_above; }
    ...
    void const set_player_hit_enemy_above(bool value) { player_hit_enemy_from_above = value; }
    void const reset_hit_flag() { player_hit_enemy_from_above = false; }
